    ...
    return (
        <div>
            <div
                ...
                <Link href="../../pages/teams" className="hover:scale-110 hover:transition-transform">EQUIPOS</Link>
                <Link href="../../page.jsx" className="hover:scale-110 hover:transition-transform">INICIO</Link>
                <Link href="../../pages/guies" className="hover:scale-110 hover:transition-transform">GUIAS</Link>
                <Link href="../../pages/farms" className="hover:scale-110 hover:transition-transform">FARMEO</Link>
            </div>
